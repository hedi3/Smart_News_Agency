...
QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from equipe where nbr_equipe BETWEEN '1' AND '50'") ;
    while(requete.next())
...
int equipe::stati1(){
    QSqlQuery query;
        int count=0 ;
        QSqlQuery requete("select * from equipe where nbr_equipe BETWEEN '1' AND '5'") ;
        while(requete.next())
...
int equipe::stati2(){
    QSqlQuery query;
        int count=0 ;
        QSqlQuery requete("select * from equipe where nbr_equipe BETWEEN '6' AND '10'") ;
        while(requete.next())
...
int equipe::stati3(){
    QSqlQuery query;
        int count=0 ;
        QSqlQuery requete("select * from equipe where nbr_equipe BETWEEN '11' AND '15'") ;
        while(requete.next())
